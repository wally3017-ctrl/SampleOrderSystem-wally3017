...
각 Phase는 **TDD(Red → Green → Refactor)** 사이클로 진행하며, 테스트는 **gmock** 프레임워크를 사용한다.

| Phase | 내용 | 세부 계획 | TDD 사이클 수 |
|-------|------|-----------|--------------|
| Phase 1 | 프로젝트 기반 구축 (MVC, 데이터 영속성) | [PHASE1.md](PHASE1.md) | 2 사이클 (1-1~1-5) |
| Phase 2 | 시료 관리 (등록/조회/검색) | [PHASE2.md](PHASE2.md) | 2 사이클 (2-1~2-5) |
| Phase 3 | 주문 관리 (접수/승인/거절) | [PHASE3.md](PHASE3.md) | 2 사이클 (3-1~3-5) |
| Phase 4 | 생산라인 (FIFO 큐, 생산량 계산) | [PHASE4.md](PHASE4.md) | 3 사이클 (4-1~4-7) |
| Phase 5 | 모니터링 + 출고 처리 + 통합 | [PHASE5.md](PHASE5.md) | 3 사이클 (5-1~5-7) |
